...
public class ashar implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("ashar"), "ir.cyber.saralahzn.ashar");
	}
...
public boolean isSingleton() {
	...
	public PCBA create(Object[] args) throws ClassNotFoundException{
		...
		pcBA = new PCBA(this, ashar.class);
...
public static ir.cyber.saralahzn.video_view _video_view = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",ashar.mostCurrent._activity,"AudioNotifi",Debug.moduleToString(ir.cyber.saralahzn.audionotifi.class),"cur1",ashar._cur1,"HttpUtils2Service",ashar.mostCurrent._httputils2service,"infomodule",Debug.moduleToString(ir.cyber.saralahzn.infomodule.class),"Main",Debug.moduleToString(ir.cyber.saralahzn.main.class),"max_item",ashar._max_item,"newMain",Debug.moduleToString(ir.cyber.saralahzn.newmain.class),"news",Debug.moduleToString(ir.cyber.saralahzn.news.class),"news_view",Debug.moduleToString(ir.cyber.saralahzn.news_view.class),"old_js",ashar.mostCurrent._old_js,"Panel1",ashar.mostCurrent._panel1,"pic_view",Debug.moduleToString(ir.cyber.saralahzn.pic_view.class),"sher_view",Debug.moduleToString(ir.cyber.saralahzn.sher_view.class),"sql",ashar._sql,"Starter",Debug.moduleToString(ir.cyber.saralahzn.starter.class),"ulvid",ashar.mostCurrent._ulvid,"video",Debug.moduleToString(ir.cyber.saralahzn.video.class),"video_view",Debug.moduleToString(ir.cyber.saralahzn.video_view.class)};
}
}